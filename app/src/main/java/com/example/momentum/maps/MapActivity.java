package com.example.momentum.maps;
...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        confirmButton = findViewById(R.id.map_confirm_button);
        confirmButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO: check if user selected a location
                // if yes then go back with that location
                // else just go with the current location
                    finish();
            }
        });

        Log.d(TAG, "onCreate: " + mMap);
